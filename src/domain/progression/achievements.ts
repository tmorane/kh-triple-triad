...
export const achievementCatalog: AchievementDefinition[] = [
  ...
  { id: 'missions_1', title: 'Mission Accomplie', condition: 'Terminer 5 missions', check: thresholdAtLeast((p) => p.achievementProgress.missionsCompleted, 5) },
  { id: 'missions_2', title: 'Agent Efficace', condition: 'Terminer 20 missions', check: thresholdAtLeast((p) => p.achievementProgress.missionsCompleted, 20) },
  { id: 'missions_3', title: 'Tableau Complet', condition: 'Terminer 50 missions', check: thresholdAtLeast((p) => p.achievementProgress.missionsCompleted, 50) },
